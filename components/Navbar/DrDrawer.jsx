...
const DrDrawer = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <List>
            <ListItemButton onClick={()=>{navigate("/ArticlePage")}} >
              <ListItemIcon>
                <ListItemText>Home</ListItemText>
              </ListItemIcon>
            </ListItemButton>
            <ListItemButton onClick={()=>{navigate("/drqna")}}>
              <ListItemIcon>
                <ListItemText>Q&A</ListItemText>
              </ListItemIcon>
            </ListItemButton>
            <ListItemButton onClick={()=>{navigate("/ContactAfterLogin")}}>
              <ListItemIcon>
            ...
            <Button sx={profilestyle} onClick={()=>{navigate("/drprofile")}}><AvatarProfile avatar={userData.AvatarUrl}  
