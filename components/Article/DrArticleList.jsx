...
function DrArticleList(props){
  ...
  const DoctorId = Number(userData.Id);
    ...
    const GetData = async () => {
      const result = await axios.get(`https://localhost:44360/api/Article/GetArticlesByDoctorId?doctorId=${DoctorId}`);
      setData(result.data);
  }
